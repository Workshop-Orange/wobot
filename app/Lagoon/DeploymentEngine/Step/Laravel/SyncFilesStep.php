...
Class SyncFilesStep extends StepBase implements StepInterface
{
    ...
    {
        $this->info("Laravel sync files steps starting");
        ...
        try {
            ...
            if($ret > 0) {
                $this->setFailure($ret, "Error syncing files");
                return $this->getReturnCode();
            }
        } catch (\Exception $ex) {
            $this->error("Error running the sync files command: " . $ex->getMessage());
